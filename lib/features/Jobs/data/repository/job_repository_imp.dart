...
class JobRepositoryImpl implements BaseJobRepository {
  final BaseJobRemoteDataSource remoteDataSource;
  ...
  @override
  Future<Either<Failure, ApplicationEntity>> applyForJob(
    ApplyJobParams params
  ) async {
    try {
      final result = await remoteDataSource.applyJob(params);
      return Right(result);
    } on ServerException catch (e) {
      return Left(ServerFailure(e.message));
    }
