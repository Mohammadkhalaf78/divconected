...
import 'package:dev_connected/features/auth/presntaion/screens/register/widgets/imaga_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<UploadCubit>(create: (context) => UploadCubit(sl())),
      ],
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ImageWidget(selectedRole: selectedRole),
